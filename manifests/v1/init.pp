...
class threatstackv1 (
  ...
  $repo_url          = $::threatstackv1::params::repo_url,
  $gpg_key           = $::threatstackv1::params::gpg_key,
  $ruleset           = $::threatstackv1::params::ruleset,
  $ts_hostname       = $::fqdn
) inherits ::threatstackv1::params {

  $ts_package = $::threatstackv1::params::ts_package

  anchor { '::threatstackv1::start': } ->
  class { '::threatstackv1::package': } ->
  anchor { '::threatstackv1::end': }
